...
urlpatterns = [
    ...
    path(
        ...
        views.TransmissionPredictionView.as_view(),
        name="predict-transmission",
    ),
    path(
        "predict/mortality/",
        views.MortalityPredictionView.as_view(),
        name="predict-mortality",
    ),
    path(
        "predict/geographical-spread/",
        views.GeographicalSpreadPredictionView.as_view(),
        name="predict-geographical-spread",
    ),
    path(
        "predict/combined/",
        views.CombinedPredictionView.as_view(),
        name="predict-combined",
    ),
    ...
    path(
        "model-metrics-summary/", views.get_model_metrics, name="model-metrics-summary"
    ),
    # 🆕 NOUVEAUX endpoints améliorés
    path(
        "model-metrics-complete/",
        views.get_model_metrics_complete,
        name="model-metrics-complete",
    ),
    path("model-metrics/sync/", views.sync_model_metrics, name="sync-model-metrics"),
    path(
        "prediction-summary/", views.get_prediction_summary, name="prediction-summary"
    ),
    ...
    path(
        ...
        views.generate_visualizations,
        name="generate_visualizations",
    ),
    path("visualizations/", views.list_visualizations, name="list_visualizations"),
    path(
        "visualizations/<str:viz_name>/",
        views.interactive_visualization,
        name="interactive_visualization",
    ),
    path("validate-model/", views.validate_model_predictions, name="validate-model"),
    path(
        "available-countries/",
        views.get_available_countries_for_validation,
        name="available-countries",
    ),
    path(
        "validate-transmission-model/",
        views.validate_transmission_model_predictions,
